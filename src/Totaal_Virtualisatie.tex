...
\input{src/sim_emu_virt}
\section{Wat is virtualisatie?}
\input{src/wat_is_virtualisatie}
\input{src/virt_history}

\chapter{The Cloud}\index{Cloud}\index{The Cloud}
\input{src/virt_cloud}
...
\input{src/containers_windows}
\section{Opdracht minikube}
\input{src/containers_opdracht_minikube}
